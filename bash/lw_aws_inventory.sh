...
function jsonoutput {
  ...
  echo "  \"_ecs_clusters\": \"$ECS_CLUSTERS\","
  echo "  \"_ecs_task_definitions\": \"$ECS_TASK_DEFINITIONS\","
  echo "  \"_ecs_fargate_running_tasks\": \"$ECS_FARGATE_RUNNING_TASKS\","
  echo "  \"_ecs_fargate_running_containers\": \"$ECS_FARGATE_RUNNING_CONTAINERS\","
  echo "  \"_ecs_fargate_total_containers\": \"$ECS_FARGATE_TOTAL_CONTAINERS\","
  echo "  \"_ecs_fargate_active_svcs\": \"$ECS_FARGATE_ACTIVE_SERVICES\","
  echo "  \"_ecs_ec2_instances\": \"$ECS_EC2_INSTANCES\","
  echo "  \"_eks_clusters\": \"$EKS_CLUSTERS\","
  echo "  \"_eks_fargate_active_profiles\": \"$EKS_FARGATE_ACTIVE_PROFILES\","
  echo "  \"_eks_ec2_nodes\": \"$EKS_NODES\","
